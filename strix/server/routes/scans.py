...
from strix.storage import get_database, ScanStatus
from strix.server.app import get_scan_engine
from strix.engine import ScanConfig
...
async def get_scan_status(scan_id: str):
    ...
    return {
        ...
        "is_active": scan_id in engine._active_scans,
    }
...
async def delete_scan(scan_id: str):
    ...
    # Stop if running
    if scan_id in engine._active_scans:

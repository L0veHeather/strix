...
from strix.plugins.base import ScanPhase, PluginEvent, VulnerabilityFinding

if TYPE_CHECKING:
    from strix.plugins.registry import PluginRegistry
    from strix.engine.event_bus import EventBus
...
class PhaseManager:
    ...
    async def execute_phase(
        ...
        """
        from strix.engine.event_bus import Event, EventType
    ...
    async def _execute_plugin(
        ...
        from strix.engine.event_bus import Event, EventType
        from strix.plugins.base import EventType as PluginEventType

...
if TYPE_CHECKING:
    from trix.telemetry.tracer import Tracer
...
from trix.core.plugin import get_plugin_manager, PluginPromptLoader
from trix.llm import LLM, LLMRequestFailedError
from trix.llm.config import LLMConfig
from trix.llm.utils import clean_content
from trix.tools import process_tool_invocations
from trix.tools.executor import ToolExecutionError
...
class BaseAgent(metaclass=AgentMeta):
    ...
    def __init__(self, config: dict[str, Any]):
        ...
        try:
            ...
            from trix.telemetry.tracer import get_global_tracer
    ...
    def _add_to_agents_graph(self) -> None:
        from trix.tools.agents_graph import agents_graph_actions
    ...
    async def _wait_for_input(self) -> None:
        ...
        if self.state.has_waiting_timeout():
            ...
            try:
                from trix.tools.agents_graph.agents_graph_actions import _agent_graph
    ...
    def _check_agent_messages(self, state: AgentState) -> None:  # noqa: PLR0912
        try:
            from trix.tools.agents_graph.agents_graph_actions import _agent_graph, _agent_messages

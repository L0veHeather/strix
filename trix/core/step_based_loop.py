...
from trix.core.step_executor import StepExecutor, ExecutionResult
from trix.core.llm_response_parser import LLMResponseParser, ResponseValidator
from trix.agents.state import StepBasedState
...
def create_step_based_loop(
    ...
    """
    from trix.core.step_executor import StepExecutor
    from trix.core.agent_philosophy import TerminationController, StepProgressionGuard
    ...
    prompt_path = Path(__file__).parent.parent / "agents" / "TrixAgent" / "agent_philosophy_prompt.jinja2"

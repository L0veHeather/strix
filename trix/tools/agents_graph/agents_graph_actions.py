...
from trix.tools.registry import register_tool
...
def create_agent(
    ...
    try:
        ...
        if module_list:
            from trix.prompts import get_all_module_names, validate_module_names
        ...
        from trix.agents import TrixAgent
        from trix.agents.state import AgentState

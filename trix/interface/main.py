...
from trix.interface.cli import run_cli
from trix.interface.tui import run_tui
from trix.interface.utils import (
...
from trix.core.plugin import get_plugin_manager
...
def parse_arguments() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Trix Multi-Agent Cybersecurity Penetration Testing Tool",
        ...
        if target_info["type"] in ("web_application", "api"):
            ...
            if url and ("localhost" in url or "127.0.0.1" in url):
                logger.info(
                    ...
                    "Since Trix runs in a Docker sandbox, 'localhost' refers to the container. "
            ...
            if ip == "127.0.0.1":
                logger.info(
                    ...
                    "Since Trix runs in a Docker sandbox, '127.0.0.1' refers to the container. "
                    "Mapping to 'host.docker.internal' for host machine access."
                )

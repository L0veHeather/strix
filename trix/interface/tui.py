...
from trix.agents.TrixAgent import TrixAgent
from trix.llm.config import LLMConfig
from trix.telemetry.tracer import Tracer, set_global_tracer
...
class ChatTextArea(TextArea):  # type: ignore[misc]
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._app_reference: TrixTUIApp | None = None

    def set_app_reference(self, app: "TrixTUIApp") -> None:
...
class SplashScreen(Static):  # type: ignore[misc]
    ...
    def _build_welcome_text(self) -> Text:
        ...
        text.append("Trix", style=Style(color=self.PRIMARY_GREEN, bold=True))
    ...
    def _build_start_line_text(self, phase: int) -> Text:
        ...
        text.append("Trix", style=strix_style)
...
class TrixTUIApp(App):  # type: ignore[misc]
    ...
    def _setup_cleanup_handlers(self) -> None:
        def cleanup_on_exit() -> None:
            self.tracer.cleanup()
            try:
                from trix.runtime import get_runtime
                runtime = get_runtime()
    ...
    def _start_scan_thread(self) -> None:
        def scan_target() -> None:
            try:
                ...
                try:
                    agent = TrixAgent(self.agent_config)
    ...
    def _render_chat_content(self, msg_data: dict[str, Any]) -> str:
        ...
        if role == "user":
            from trix.interface.tool_components.user_message_renderer import UserMessageRenderer
    ...
    def _render_tool_content_simple(self, tool_data: dict[str, Any]) -> str:
        ...
        from trix.interface.tool_components.registry import get_tool_renderer
    ...
    def _send_user_message(self, message: str) -> None:
        ...
        try:
            from trix.tools.agents_graph.agents_graph_actions import send_user_message_to_agent
    ...
    def action_confirm_stop_agent(self, agent_id: str) -> None:
        ...
        try:
            from trix.tools.agents_graph.agents_graph_actions import stop_agent
    ...
    def _restart_scan_process(self) -> None:
        ...
        try:
            from trix.tools.agents_graph.agents_graph_actions import reset_agent_graph
            reset_agent_graph()
        except ImportError:
            pass
...
async def run_tui(args: argparse.Namespace) -> None:
    ...
    app = TrixTUIApp(args, log_queue=log_queue)
